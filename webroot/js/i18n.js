...
export const translations = {
    'zh': {
        ...
        'config_freq_mhz': '频率 (MHz)',
        'config_volt_uv': '电压 (uV)',
        'config_ddr_level': '内存档位',
        'config_edit': '编辑',
        'config_loading': '加载中...',
        ...
        'config_balance_mode': '平衡模式设置',
        'config_performance_mode': '性能模式设置',
        'config_fast_mode': '极速模式设置',
        'config_ultra_simple_threshold': '极简阈值 (%):',
        'config_margin': '余量 (%):',
        'config_down_counter_threshold': '降频计数器阈值:',
        'config_aggressive_down': '激进降频',
