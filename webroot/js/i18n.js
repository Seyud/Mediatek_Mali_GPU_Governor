...
export const translations = {
    'zh': {
        ...
        'config_ultra_simple_threshold': '超简单阈值 (%):',
        'config_margin': '余量 (%):',
        'config_down_counter_threshold': '下降计数阈值:',
        'config_sampling_interval': '采样间隔 (ms):',
        'config_min_adaptive_interval': '最小自适应间隔 (ms):',
        'config_max_adaptive_interval': '最大自适应间隔 (ms):',
        'config_up_rate_delay': '上升速率延迟 (ms):',
        'config_down_rate_delay': '下降速率延迟 (ms):',
        'config_aggressive_down': '激进下降策略',
        'config_gaming_mode': '游戏模式',
